...
<head>
	...
	<style>
		...
		#nbsno_th,#mac_th,#project_th,#nbsno,#mac,#project{
			width: 230px;
			height: 10px;
		}
		#result_th,#status_th,#result,#status{
			width: 70px;
			height: 10px;
		}
		#date_th,#date{
...
<body align="center">
     <table align="center" border="1">
		...
		<%
            ...
            Do While Not rs.EOF
                Response.Write "<tr>"
				Response.Write "<td id='number'>" & number & "</td>"
                Response.Write "<td id='nbsno'>" & rs("NBSNO") & "</td>"
                Response.Write "<td id='mac'>" & rs("mac") & "</td>"
				Response.Write "<td id='project'>" & rs("item_no") & "</td>"
				Response.Write "<td id='result'>" & rs("result_log") & "</td>"
                Response.Write "<td id='status'>" & rs("create_user") & "</td>"
                Response.Write "<td id='date'>" & rs("create_date") & "</td>"
				Response.Write "</tr>"
				number = number + 1
                rs.MoveNext
            Loop
